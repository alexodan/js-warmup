...
// 2 - make the thingy appear
var index = Math.floor(Math.random() * board.children.length);
// var thingyPosition = convertToCoordinates2D(index);
var thingy = board.children[index];
...
// 5 - logic when the snake eat the thingy
// check the dom elements of head and thingy to be equal
